!(function (t, e, n) {
  ...
  var o = /\+/g,
    s = (t.cookie = function (n, o, i) {
      ...
      for (
        var u = s.raw ? a : r, g = e.cookie.split("; "), l = 0, m = g.length;
        l < m;
        l++
      ) {
        var f = g[l].split("=");
  ...
  (s.defaults = {}),
    (t.removeCookie = function (e, n) {
      return null !== t.cookie(e) && (t.cookie(e, null, n), !0);
    });
})(jQuery, document),
  $("ul.tabs").each(function () {
    var t,
      e,
      n = $(this).find("a");
    (t = $(n.filter('[href="' + location.hash + '"]')[0] || n[0]))
      .parent("li")
      .addClass("active"),
      (e = $(t.attr("href"))),
      n.not(t).each(function () {
        $($(this).attr("href")).hide();
      }),
      $("a", this).click(function (n) {
  ...
  (window.Rainbow = (function () {
    function t(t) {
      var e,
        n = (t.getAttribute && t.getAttribute("data-language")) || 0;
      if (!n)
    ...
    function e(e) {
      ...
      if (!n) {
        var a = /\blang(?:uage)?-(\w+)/;
        (e = e.className.match(a) || e.parentNode.className.match(a)) &&
          (n = e[1]);
      }
      return n;
    }
    function n(t, e) {
      for (var n in f[w])
        if (
          ((n = parseInt(n, 10)),
          (t == n && e == f[w][n] ? 0 : t <= n && e >= f[w][n]) &&
            (delete f[w][n], delete m[w][n]),
          (t >= n && t < f[w][n]) || (e > n && e < f[w][n]))
        )
          return !0;
      return !1;
    }
    ...
    function r(t, e, i, p) {
      ...
      if (u) {
        ++v,
          !e.name &&
            "string" == typeof e.matches[0] &&
            ((e.name = e.matches[0]), delete e.matches[0]);
        var g = u[0],
          l = u.index,
          h = u[0].length + l,
          d = function () {
                ...
                if (o) {
                  var i = e.matches[n[t]],
                    ...
                    m = function (e, o, s) {
                      ...
                      (o = s ? a(s, o) : o),
                        (g = g.substr(0, i) + g.substr(i).replace(e, o)),
                        y(++t, n, r);
                    };
                  p
                    ? c(o, p, function (t) {
                    ...
                    : "string" == typeof i
                    ? m(o, o, i)
                    : s(o, l.length ? l : [l], function (t) {
                        m(o, t, i.matches ? i.name : 0);
                      });
                } else y(++t, n, r);
              }
            };
    ...
    function s(t, e, n) {
      function a(e, o) {
        o < e.length
          ? r(e[o].pattern, e[o], t, function () {
              a(e, ++o);
            })
          : i(t, function (t) {
              delete m[w], delete f[w], --w, n(t);
            });
      }
      ++w, a(e, 0);
    }
    ...
    function p(t, n, a) {
      if (n < t.length) {
        var r = t[n],
          o = e(r);
        return -1 < (" " + r.className + " ").indexOf(" rainbow ") || !o
          ? p(t, ++n, a)
          : ((o = o.toLowerCase()),
            (r.className += r.className ? " rainbow" : "rainbow"),
            c(r.innerHTML, o, function (e) {
              (r.innerHTML = e),
                (m = {}),
                (f = {}),
                l && l(r, o),
    ...
    function u(t, e) {
      var n,
        a = (t =
          t && "function" == typeof t.getElementsByTagName
            ? t
      ...
      for (n = 0; n < a.length; ++n)
        a[n].getElementsByTagName("code").length || o.push(a[n]);
      p(o, 0, e);
    }
    var g,
      l,
