...
const generateDateRange = (startDate, endDate) => {
  ...
  render() {
    ...
    const sortedData = this.state.filteredData.sort((a, b) => b.videoService - a.videoService);
                ...
                <div className="card-body">
                  <div className="d-flex align-items-center">
                    ...
                    { !userId && 
                      <button 
                              type="button"
                              className="btn btn-primary bg-dark" id="Article" 
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary"> <Link to={`/doctor/${this.state.docId}`} className="text-white">Go to Doctor's Profile</Link></button>
      </div>
    </div>
  </div>
</div>
