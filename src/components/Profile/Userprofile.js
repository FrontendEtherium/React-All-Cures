...
export default function Userprofile(props) {
  ...
  const getSubsnum = () => {
    ...
    axios
      .get(`${backendHost}/users/subscriptiondetails/${mobile}/cc/91`)
  ...
  const getProfile = () => {
    axios
      ...
      .then((res) => {
        ...
        fetchDoctorData(res.data.docID);
      })
      .catch((err) => {
        return;
      });
                  ...
                  <div className="col-md-3 mr-3">
                    <div className="profileImageBlok">
                      <div className="profile-card-img text-center">
                        ...
                        <img
                          src={`${imagePath}/cures_articleimages/patients/${userId}.png?d=${parseInt(
                            Math.random() * 1000
                          )}`}
                          onError={(e) => onError(e)}
                        />
