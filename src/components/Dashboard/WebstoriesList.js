                ...
                .map(i => {
                    return(
                        <div className="card col-md-5 mt-5 mx-3 border p-3 h6">
                            ...
                            <div className="card-title h4"><span className="font-weight-bold">Title:</span> {i.title}</div>
                            <div className="pb-2"><span className="font-weight-bold">ID: </span>{i.webID}</div>
                            ...
                            <Link to={`/dashboard?webstoriesUpdate=${i.webID}`} className="col-md-3 btn mr-2" style={{backgroundColor: '#9289be', color: '#fff'}}>Edit</Link>
